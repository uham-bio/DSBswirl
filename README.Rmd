...
- DSB-03: Data warangling and introduction to tidyverse (Datenaufbereitung oder per Anleitung durchs Tidyversum)
- DSB-04: Data visualization with ggplot2 (Datenvisualisierung mit ggplot2)
- DSB-05: Handling of special data types (Handling spezieller Datentypen)
...
- Fixed bugs in DSB-01, DSB-02, DSB-04 and DSB-05 that caused lesson to crash in cases where user skipped a specific question
